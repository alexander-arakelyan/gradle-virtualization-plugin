...
public class KubernetesCreateNamespaceTask extends AbstractExecTask<KubernetesCreateNamespaceTask> {
    public KubernetesCreateNamespaceTask() {
        super(KubernetesCreateNamespaceTask.class);
    }
